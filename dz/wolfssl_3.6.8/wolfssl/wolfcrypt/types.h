...
#define WOLF_CRYPT_TYPES_H
	...
	/* XFREE on some embeded systems doesn't like free(0) so test  */
	    ...
	    #define XMEMCPY(d,s,l)    fnet_memcpy((d),(s),(l))
	    #define XMEMSET(b,c,l)    fnet_memset((b),(c),(l))
	    #define XMEMCMP(s1,s2,n)  fnet_memcmp((s1),(s2),(n))
	    #define XMEMMOVE(d,s,l)   memmove((d),(s),(l))

	    #define XSTRLEN(s1)       fnet_strlen((s1))
	    #define XSTRNCPY(s1,s2,n) fnet_strncpy((s1),(s2),(n))
	    /* strstr, strncmp, and strncat only used by wolfSSL proper,
         * not required for wolfCrypt only */
	    #define XSTRSTR(s1,s2)    fnet_strstr((s1),(s2))
	    #define XSTRNSTR(s1,s2,n) mystrnstr((s1),(s2),(n))
	    #define XSTRNCMP(s1,s2,n) fnet_strncmp((s1),(s2),(n))
	    #define XSTRNCAT(s1,s2,n) fnet_strncat((s1),(s2),(n))
	    #ifndef USE_WINDOWS_API
	        #define XSTRNCASECMP(s1,s2,n) fnet_strncasecmp((s1),(s2),(n))
	    #else
